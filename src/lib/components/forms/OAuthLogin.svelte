...
<div class="grid gap-4 my-4">
	...
	<form class="grid gap-2" method="POST" use:enhance={submitSocialLogin}>
		<button
			...
			class="flex items-center justify-center gap-2 bg-black text-white rounded p-2 w-full"
			><img
				class="w-5 invert"
		...
		<button
			...
			class="flex items-center justify-center gap-2 bg-indigo-500 text-white rounded p-2 w-full"
			><img
				class="w-5"
