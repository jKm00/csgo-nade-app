...
<div class="grid gap-2">
	...
	<div class="flex gap-[1px] text-sm">
		...
		<button
			class="flex items-center justify-center gap-1 w-20 bg-neutral-700 py-1 px-3 hover:bg-neutral-600 focus-within:bg-neutral-600 active:bg-neutral-500"
			on:click={() => showFilters.set(!get(showFilters))}
		>
			{#if $showFilters}
				<svg
					class="w-3"
